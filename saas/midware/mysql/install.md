...
### [参考](http://woshub.com/mariadb-install-configure-tunning-centos/#h2_1)
...
> - datadir 存放数据库文件
> - tmpdir 
> - skip-name-resolve 禁止dns 解析
> - max_allowed_packet  ,最大的包，mysql  blob 字段 >= max_allowed_packet
> - max_connections  最大连接数
> - `# Cache parameters`
> - `# InnoDB parameters`
> - innodb_buffer_pool_size (空闲内存的70%-80%)
> - innodb_flush_method  O_DIRECT(禁止使用os 缓存)
...
### 脚本  [连接](https://launchpadlibrarian.net/78745738/tuning-primer.sh)
